...
function loadSettings() {
  ...
  if (saved) {
    try {
      ...
      if (settings.soil) CFG.soil = settings.soil;
...
function resetToDefaults() {
  if (confirm('Reset all settings to defaults? This cannot be undone.')) {
    ...
    CFG.soil = JSON.parse(JSON.stringify(DEFAULT_CFG.soil));
    ...
    localStorage.removeItem('kbStoneSoilType');
    localStorage.removeItem('kbStoneProjectType');
