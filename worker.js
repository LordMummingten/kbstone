...
function calcGroup(g) {
  ...
  // NEW: Calculate total wall length with corner deductions
    ...
    if (g.isStairs) {
      ...
      for (var ri = 0; ri < g.wallRuns.length; ri++) {
        ...
        if (ri < g.wallRuns.length - 1) {
          h += '<div style="text-align:center;color:var(--blue);font-weight:600;margin:4px 0;">â–¼ Corner â–¼</div>';
        }
      }
